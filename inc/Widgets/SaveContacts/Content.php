...
?>
        <div class="container top-container">
            <div class="profile-card">
                ...
                <div class="text-data">
                    <h2 class="name"><?php echo esc_html($settings['first_name']); ?> Dahamya</h2>
    ...
    public static function template($widget, $content_data)
    {
    ...
    ?>
        <div class="container top-container">
            <div class="profile-card">
                <div class="image">
                    <# var image={ id: settings.<?php echo $content_data['profile_image']; ?>.id, url: settings.<?php echo $content_data['profile_image']; ?>.url, size: settings.image_size, dimension: settings.image_custom_dimension, model: view.getEditModel() }; var image_url=elementor.imagesManager.getImageUrl( image ); if ( ! image_url ) { return; } #>
                        <!-- <img src="profile-image.jpg" alt="" class="profile-img"> -->
                        <img src="{{{ settings.<?php echo $content_data['profile_image']; ?>.url }}}" class="profile-img" />
                </div>

                <div class="text-data">
                    <h2 class="name">{{{settings.first_name}}} Dahamya</h2>
                    <span class="job">CEO - coder.lk</span>
                </div>
                <div class="save-contact">
                    <button class="save-contact-btn">
